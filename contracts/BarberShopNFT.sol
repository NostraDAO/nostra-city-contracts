...
contract NostraCityBarberShop is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
    ...
    constructor(IERC20 DAI) ERC721("NostraCityBarberShop", "NCBS") {
        _DAI = DAI;
    }
    ...
    function safeMint(address to, string memory uri, uint8 numberOfTokens) public onlyOwner payable {
       ...
       // require(presaleActive, "Barbershop has not launched.");
        require(!mintingPaused, 'Minting is paused');
		require(numberOfTokens > 0, 'Mint at least 1 BarbershopHaircut');
